...
public class View {
	...
	public GroupBox openGroupConversation(){
		...
		if(this.groupSelectionWindow.possibleToCreate()){ /* si au moins 2 utilisateurs ont �t� selectionnes */
			...
			// TODO : ouverture d'une fenetre d'erreur pour indiquer que le nombre de destinataires doit etre superieur � 2 
			return null;
		}
