...
public class PeriodicHello extends Thread {
	...
	public void run(){
		/* boucle tant que la variable 'execute' n'est pas modifi�e par la classe UsersWindow */
		while(execute){
			sendMyObject(hello);
		...
		/* thread arr�t� car click sur le bouton 'deconnection'
		 * 		-> il faut donc envoyer un message d'indication de d�connexion
		 */
